...
/****** Object:  Database [AdventureWorks2017]    Script Date: 08-02-2022 18:50:06 ******/
CREATE DATABASE [AdventureWorks2017]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'AdventureWorks2017', FILENAME = N'/var/opt/mssql/data/AdventureWorks2017.mdf' , SIZE = 270336KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'AdventureWorks2017_log', FILENAME = N'/var/opt/mssql/data/AdventureWorks2017_log.ldf' , SIZE = 73728KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
